...
// inline void _print_keys_str(h_t* h) {
// 	printf("printing keys....\n");
// 	for (i_t i=0; i<h->num_buckets; ++i){
// 		if (!_flags_isempty(h->flags, i)) {
// 			kbox_t key_box = _get_key(h, GET_PTR(i, h->k_step_increment));
// 			print_str(key_box.str, key_box.len);
// 		}
// 	}
// }


// inline void _print_keys_str2(h_t* h, i_t* flags, i_t num_buckets) {
// 	printf("printing keys....\n");
// 	for (i_t i=0; i<num_buckets; ++i){
// 		if (!_flags_isempty(flags, i)) {
// 			kbox_t key_box = _get_key(h, GET_PTR(i, h->k_step_increment));
// 			print_str(key_box.str, key_box.len);
// 		}
// 	}
...
// inline void find_uncommon_keys_1(h_t* h, kbox_t* boxes, int num){
...
// 			for (i_t j=0; j<num; ++j){
// 				kbox_t b = boxes[j];
// 				if (_key_equal(h, GET_PTR(i, h->k_step_increment), b))
// 					found = true;
// 			}			
...
// inline void find_uncommon_keys_2(h_t* h, kbox_t* boxes, int num){
